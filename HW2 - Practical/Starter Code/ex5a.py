...
hamed_private_key = CBitcoinSecret('cSRQ7UJTdDM3dLMPN6eq9yUW25fP2TZniAJqvpCCg9Hz82kVEk3G')
hamed_public_key = hamed_private_key.pub
hamed_address = P2PKHBitcoinAddress.from_pubkey(hamed_public_key)
Q5a_txout_scriptPubKey = [1606939500000, OP_CHECKLOCKTIMEVERIFY, OP_DROP, OP_DUP, OP_HASH160, hamed_address, OP_EQUALVERIFY, OP_CHECKSIG]
######################################################################
...
if __name__ == '__main__':
    ...
    response = send_from_P2PKH_transaction(amount_to_send, txid_to_spend, utxo_index, Q5a_txout_scriptPubKey, my_private_key, network_type)
